  ...
  \begin{columns}[T]
    \begin{column}{0.46\textwidth}
      ...
      \begin{itemize}
        ...
        \item Main DAC uses a very small \textbf{0.3 fF unit capacitor} to save power.
    ...
    \begin{column}{0.54\textwidth}
      \centering
      \includegraphics[width=0.86\linewidth]{Figures/Figure2.png}

      \includegraphics[width=0.72\linewidth]{Figures/Figure5_crop.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Digital Side: Lightweight Controller}
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      \centering
      \includegraphics[width=0.86\linewidth]{Figures/Figure10.png}

      \vspace{1mm}

      \includegraphics[width=\linewidth]{Figures/Figure11_crop.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Analog Side: Physical Error Correction}
  \begin{columns}[T]
    ...
    \begin{column}{0.50\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Figures/Figure13a_crop.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Measurements Summary}
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Figures/Figure22_crop.png}
    \end{column}
  \end{columns}
\end{frame}
