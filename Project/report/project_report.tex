...
\end{axis}
\end{tikzpicture}
\caption{SNDR-convergence plot in the style of the paper's Fig.~22, evaluated directly from the implemented dynamic SAR output model using the recorded trim trajectory. The horizontal scale is expressed directly in conversion samples, and the converged SNDR of the logged run is approximately \SI{73.7}{dB}.}
\label{fig:sndrconv}
\end{figure}
